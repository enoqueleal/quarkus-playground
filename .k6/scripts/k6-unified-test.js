...
function unifiedSummary(data, options) {
  ...
  return `
UNIFIED PERFORMANCE TEST SUMMARY - Random Names API
================================================
...
<body>
    <div class="header">
        ...
        <h2>Random Names API - Progressive Load Test</h2>
    ...
    <table>
        ...
        <tr><td>Target Endpoint</td><td>http://localhost:8081/api/random-names</td></tr>
